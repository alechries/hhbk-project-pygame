...
class Piece:
    ...
    def __init__(self, row, col, color):
        ...
        self.color = color
        self.king = False
        self.calc_pos()  # Berechnet die Position beim Erstellen des Spielsteins
    ...
    def draw(self, win):
        ...
        if self.king:
            pygame.draw.circle(win, BLACK, (self.x, self.y), radius // 2)  # Ersetze Krone durch einen kleineren schwarzen Kreis

    def move(self, row, col):
        self.row = row
        self.col = col
        self.calc_pos()  # Berechnet die Position nach dem Bewegen des Spielsteins
